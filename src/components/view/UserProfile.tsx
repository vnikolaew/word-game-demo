...
// Icons
import { Trash2, LogOut, Ban, CircleSlash, Key, Loader } from "lucide-react";
         ...
         <div className="flex flex-col sm:flex-row gap-4">
            ...
            <AlertDialog>
               ...
               <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                     <AlertDialogCancel disabled={isLoading} className={`!cursor-pointer`}>إلغاء</AlertDialogCancel>
                     <AlertDialogAction
